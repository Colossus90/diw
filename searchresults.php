...
<head>
    <meta charset="UTF-8">
    <title>Zoekresultaten voor zoekopdracht</title>
...
<!-- aantal resultaten voor zoekopdracht -->
<div>
    <h2 id="resultaatTitel">x resultaten voor '<?php echo $_GET['search'] ?>'</h2>
</div>

<!-- zoekresultaten: kleine artikels -->
<section id="artikels">
